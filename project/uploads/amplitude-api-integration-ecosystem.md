...
| **[Ad Network Source (Google, Facebook, TikTok, Bing, LinkedIn)](https://amplitude.com/docs/data/source-catalog)** | 📥 In | Pull ad spend, impressions, and click data into Amplitude for campaign analysis | Section 3 |
...
| **[Marketing Automation Destination](https://amplitude.com/docs/data/destination-catalog)** | 📤 Out | Sync cohorts or stream events to Braze, Iterable, Customer.io, HubSpot, etc. | Section 5 |
...
| 🥉 3 | **Braze** | Marketing Automation | 🔄 Both | Sends Braze engagement events (email opens, push clicks, campaign interactions) into Amplitude | Understand how marketing campaign touchpoints from Braze influence in-product behavior and downstream retention | [Docs](https://amplitude.com/docs/data/source-catalog/braze) |
| 4 | **Iterable** | Marketing Automation | 📥 In | Ingests Iterable campaign engagement events into Amplitude | Correlate email and push notification engagement with product activation and conversion funnels | [Docs](https://amplitude.com/docs/data/source-catalog/iterable) |
...
| 6 | **AppsFlyer** | Attribution | 📥 In | Sends mobile attribution and install data from AppsFlyer into Amplitude | Link paid UA campaign performance to in-app behavioral funnels — see which ad networks drive your highest-LTV users | [Docs](https://amplitude.com/docs/data/source-catalog/appsflyer) |
...
| 8 | **Google Tag Manager** | Marketing Analytics | 📥 In | Triggers Amplitude SDK calls via GTM tags on web properties — client-side and server-side | Marketing teams instrument Amplitude on landing pages or web funnels without requiring engineering changes | [Docs](https://amplitude.com/docs/data/source-catalog/google-tag-manager) |
...
> Most major ad networks are fully bidirectional — they send spend/impression data INTO Amplitude for campaign analysis, and receive cohort syncs or conversion event streams OUT of Amplitude for targeting and optimization.

| Partner | Direction | As a Source — What Comes INTO Amplitude | As a Destination — What Goes OUT of Amplitude | Source Docs | Destination Docs |
|---------|-----------|----------------------------------------|-----------------------------------------------|-------------|-----------------|
| **Google Ads** | 🔄 Both | Imports spend, click, impression, and conversion data daily for campaign analysis alongside product behavior | Cohort Sync: syncs behavioral cohorts for audience targeting. Event Stream: forwards conversion events for Smart Bidding optimization | [Source](https://amplitude.com/docs/data/source-catalog/google-ads) | [Cohort](https://amplitude.com/docs/data/destination-catalog/google-ads-cohort-syncing) · [Event Stream](https://amplitude.com/docs/data/destination-catalog/google-ads) |
| **Facebook Ads / Meta Pixel** | 🔄 Both | Imports Facebook Ads spend, click, and impression data for campaign performance analysis | Facebook Ads: cohort sync to custom audiences for retargeting and lookalike modeling. Meta Pixel: event streaming via Conversions API for server-side conversion tracking | [Source](https://amplitude.com/docs/data/source-catalog/facebook-ads) | [Cohort](https://amplitude.com/docs/data/destination-catalog/facebook-ads) · [Event Stream](https://amplitude.com/docs/data/destination-catalog/meta-pixel) |
| **TikTok Ads** | 🔄 Both | Imports TikTok Ads spend, click, and impression data daily for campaign analysis | Cohort Sync: syncs behavioral cohorts for retargeting. Event Streaming: forwards in-app events via TikTok Events API in real time | [Source](https://amplitude.com/docs/data/source-catalog/tiktok-ads) | [Cohort](https://amplitude.com/docs/data/destination-catalog/tiktok-ads) · [Event Stream](https://amplitude.com/docs/data/destination-catalog/tiktok-ads-event-stream) |
| **Bing Ads** | 🔄 Both | Imports Bing Ads spend, click, impression, and conversion data; backfills up to one year of historical data | Cohort Sync: syncs behavioral cohorts. Event Streaming: forwards server-side conversion events via Microsoft Conversions API (CAPI) | [Source](https://amplitude.com/docs/data/source-catalog/bing-ads) | [Cohort](https://amplitude.com/docs/data/destination-catalog/bing-ads-cohort-sync) · [Event Stream](https://amplitude.com/docs/data/destination-catalog/bing-ads-event-stream) |
| **LinkedIn Ads** | 🔄 Both | Imports LinkedIn Ads spend, click, and impression data for B2B campaign analysis | Event Streaming: streams conversion events to LinkedIn Ads for conversion tracking and campaign optimization | [Source](https://amplitude.com/docs/data/source-catalog/linkedin-ads) | [Destination](https://amplitude.com/docs/data/destination-catalog/linkedin-ads) |
| **X Ads (Twitter)** | 📥 In only | Imports X Ads spend, click, and impression data. Campaign-level metrics imported once per day. | ❌ No destination connector | [Source](https://amplitude.com/docs/data/source-catalog/x-ads) | — |
| **Snapchat** | 📤 Out only | ❌ No source connector | Cohort Sync: syncs behavioral cohorts as custom audiences for personalized campaign targeting | — | [Destination](https://amplitude.com/docs/data/destination-catalog/snapchat) |
...
| Rank | Partner | Category | Direction | What It Does | Example Use Case | Docs |
|------|---------|----------|-----------|--------------|-----------------|------|
| 🥇 1 | **Braze** | Marketing Automation | 🔄 Both | Syncs behavioral cohorts to Braze for targeted messaging; receives Braze campaign engagement events back into Amplitude | Send a cohort of users who viewed a feature but didn't convert to a Braze nurture campaign — measure whether that campaign drove conversion | [Docs](https://amplitude.com/docs/data/destination-catalog/braze) |
| 🥈 2 | **HubSpot** | CRM | 🔄 Both | Syncs Amplitude behavioral cohorts and event streams into HubSpot contacts and lists | Automatically update HubSpot lead scores based on in-product behavior — users who hit activation milestones get routed to sales | [Docs](https://amplitude.com/docs/data/destination-catalog/hubspot) |
| 🥉 3 | **Customer.io** | Marketing Automation | 📤 Out | Streams Amplitude events and syncs cohorts to Customer.io for lifecycle messaging | Trigger onboarding email sequences the moment a user completes a specific in-app action tracked in Amplitude | [Docs](https://amplitude.com/docs/data/destination-catalog/customer-io) |
| 4 | **Iterable** | Marketing Automation | 🔄 Both | Streams events and syncs cohorts from Amplitude to Iterable for cross-channel campaigns | Power Iterable journeys with real-time behavioral triggers — a user who drops off at checkout gets an automated re-engagement push | [Docs](https://amplitude.com/docs/data/destination-catalog/iterable) |
...
| Rank | Partner | Category | Direction | What It Does | Example Use Case | Docs |
|------|---------|----------|-----------|--------------|-----------------|------|
| 🥇 1 | **Intercom** | Customer Engagement | 🔄 Both | Streams Amplitude behavioral events to Intercom and syncs cohorts for targeted in-app messaging | Trigger Intercom messages when users reach specific behavioral milestones tracked in Amplitude | [Docs](https://amplitude.com/docs/data/destination-catalog/intercom) |
...
|---------|----------|-----------|--------------|-----------------|------|
| **AppsFlyer** | Attribution | 🔄 Both | Streams Amplitude in-app conversion events back to AppsFlyer for attribution modeling | Send purchase and subscription events from Amplitude to AppsFlyer to measure true post-install conversion by channel | [Docs](https://amplitude.com/docs/data/destination-catalog/appsflyer) |
